...
//************************** DECLARACIONES *************************************
void Config(void);
void MideF(char sensor, char color, char Texp); //Texp=1 500us, Texp=2 1ms, Texp=3 1.5ms, Texp=4 2ms
...
void MideF(char sensor, char color, char Texp)
{
 //sleccionar color
 //S3=PD4 S2=PD6   Color
 //  0      0      Rojo
...
//---teimpo de exposicion ------------------------
 //Texp=1 500us, Texp=2 1ms, Texp=3 1.5ms, Texp=4 2ms  

 //Seleccionar sensor
 switch(Texp)
 {
  case 1:   //ventana de tiempo 500us a 16Mhz
  	   		OCR0A = 0x1F;  //
 			OCR0B = 0x1F;  //
 			TCNT0 = 0xE1;  //
			break;
  case 2:   //ventana de tiempo 1ms a 16Mhz
  	   		OCR0A = 0x3E;  //
 			OCR0B = 0x3E;  //
 			TCNT0 = 0xC2;  //
			break;
  case 3:   //ventana de tiempo 1.504ms a 16Mhz
  	   		OCR0A = 0x5E;  //
 			OCR0B = 0x5E;  //
 			TCNT0 = 0xA2;  //
			break;
  case 4:   //ventana de tiempo 2ms a 16Mhz
  	   		OCR0A = 0x7D;  //
 			OCR0B = 0x7D;  //
 			TCNT0 = 0x83;  //
			break;
 ...
 TCCR0B = 0x04; //start timer CLK/256 
